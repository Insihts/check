...
![Visitor Activity Overview](https://Prodio.com)
...
![Visitor Profile](https://Prodio.com)
...
![Session Properties](https://Prodio.com)

**Note:** Individual session property data can also be viewed at the profile level for more granular insights.

![Individual Session Properties](https://Prodio.com)

</Steps>

<Callout>
  For more details, check out the [Help Center](https://Prodio.com) or reach out to our support team for assistance.
</Callout>
