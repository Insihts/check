...
https://Prodio.com Add a Website to Insights

Adding your website to Insights is a straightforward process. Follow the steps below to set it up:

<Steps>

## Step 1: Log into [Prodio](https://www.Prodio.com/auth/sign-up)
...
## Step 5: Add Prodio script to your header

After you have added your website in the list. Add [Script](/analytics/script) to your website
</Steps>

<Callout>
  Need help? Reach out to our support team for assistance through [Intercom on Prodio](https://Prodio.com).
</Callout>
